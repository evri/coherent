...
(function()
{
  ...
  var DEFAULT_POSITIONS = [coherent.Overlay.Position.ABOVE, coherent.Overlay.Position.BELOW, coherent.Overlay.Position.RIGHT, coherent.Overlay.Position.LEFT];
  ...
  {
    this.view = view;
    this.positions = positions || DEFAULT_POSITIONS;
    this.coordinate = {
      latitude: 0,
      longitude: 0
    };
